...
def build_system_prompt() -> str:
    ...
    return (
        ...
        f"{building_info}\n\n"
        "\n\n"
        "For EVERYTHING ELSE -- pubs, cafes (other than the Town Hall's own), shops, events, "
        "attractions, directions, recommendations, weather, the current date or time, or "
        "anything current, general, or specific that you don't already know for certain -- "
        "use the web_search tool to get real, up to date information, then answer concisely "
        "in your own words. This includes general questions unrelated to Hebden Bridge too "
        "(e.g. today's date, current weather anywhere, general facts) -- always search rather "
        "than saying you can't help, unless the question is truly impossible to look up. Don't "
